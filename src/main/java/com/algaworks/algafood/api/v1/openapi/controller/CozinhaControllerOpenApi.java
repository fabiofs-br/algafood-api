...
public interface CozinhaControllerOpenApi {
    ...
    @Operation(summary = "Busca uma cozinha por ID", responses = {
            ...
            @ApiResponse(responseCode = "400", description = "ID da cozinha inválida", content = {
    ...
    CozinhaModel buscar(@Parameter(description = "ID de um cozinha", example = "1", required = true) Long cozinhaId);

    @Operation(summary = "Cadastra uma cozinha", responses = {
            @ApiResponse(responseCode = "201", description = "Cozinha cadastrada"),
    })
    CozinhaModel adicionar(@RequestBody(description = "Representação de uma nova cozinha", required = true)
    ...
    @Operation(summary = "Exclui uma cozinha por ID", responses = {
            ...
            @ApiResponse(responseCode = "400", description = "ID do cozinha inválida", content = {
                    @Content(schema = @Schema(ref = "Problema"))
            }),
            @ApiResponse(responseCode = "404", description = "Cozinha não encontrada", content = {
                    @Content(schema = @Schema(ref = "Problema"))
