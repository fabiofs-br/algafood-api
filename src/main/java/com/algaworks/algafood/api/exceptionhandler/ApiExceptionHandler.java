...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<Object> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex,
        ...
        String detail = String.format("O parâmetro de URL '%s' recebeu valor '%s', que é de um tipo inválido." +
    ...
    public ResponseEntity<Object> handleAcessDenied(AccessDeniedException ex, WebRequest request) {
    ...
    public ResponseEntity<Object> handleEntidadeNaoEncontrado(
    ...
    private static String joinPath(List<Reference> ex) {
        return ex.stream()
