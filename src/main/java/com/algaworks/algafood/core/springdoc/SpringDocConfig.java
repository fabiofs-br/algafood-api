...
public class SpringDocConfig {
    ...
    public OpenAPI openAPI() {
        ...
        SpringDocUtils.getConfig().replaceWithClass(org.springframework.hateoas.Links.class, LinksModel .class);
        ...
        return new OpenAPI()
                .info(new Info()
                        ...
                        new Tag().name("Cozinhas").description("Gerencia os cozinhas"),
    ...
    public OpenApiCustomizer openApiCustomizer() {
        return openApi -> {
            openApi.getPaths()
                    .values()
                    .forEach(pathItem -> addOperationResponses(pathItem));
        };
    }

    private static void addOperationResponses(PathItem pathItem) {
                ...
                .forEach((httpMethod, operation) -> {
                    ...
                    switch (httpMethod) {
                        ...
                        case POST:
                            ...
                            break;
                        case PUT:
                            addPutResponses(responses);
                            break;
                        case DELETE:
                            addDeleteResponses(responses);
                            break;
                        default:
                            addDefaultResponses(responses);
                    }
                });
    }

    private static void addGetResponses(ApiResponses responses) {
    ...
    private static void addPostResponses(ApiResponses responses) {
    ...
    private static void addPutResponses(ApiResponses responses) {
            responses.addApiResponse("400", new ApiResponse()
                    .$ref(badRequestResponse));
            responses.addApiResponse("500", new ApiResponse()
                    .$ref(internalServerErrorResponse));
    ...
    private static void addDeleteResponses(ApiResponses responses) {
            responses.addApiResponse("500", new ApiResponse()
                    .$ref(internalServerErrorResponse));
    }

    private static void addDefaultResponses(ApiResponses responses) {
            responses.addApiResponse("500", new ApiResponse()
                    .$ref(internalServerErrorResponse));
    }
